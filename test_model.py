...
def main(cfg: DictConfig):
    ...
    cfg_keys_to_load = [
        ("hyp", "alpha"), ("hyp", "epochs"), ("hyp", "lr"), ("hyp", "lr_factor"),
        ("model", "max_iters"), ("model", "model"), ("hyp", "optimizer"),
        ("hyp", "train_mode"), ("model", "width"),
    ]
    ...
    if cfg.problem.data_type not in ("zind", "trial"):
    ...
    net, _, _ = dt.utils.load_model_from_checkpoint(
        cfg.problem.name, cfg.problem.model, device, testing=True
    )
    ...
    if cfg.quick_test:
        test_acc = dt.test(
            ...
            terminals, cfg.problem.parallel_testing, cfg.termination_condition,
            cfg.time_evaluation, cfg.accuracy_evaluation,
            tc_threshold=cfg.problem.tc_threshold,
            tc_first_batch=cfg.problem.tc_first_batch,
        )
        ...
        test_acc, val_acc, train_acc = dt.test(
            ...
            cfg.problem.hyp.test_mode, test_iterations,
            cfg.problem.name, device, cfg.problem.numchunks, cfg.problem.overlap,
            terminals, cfg.problem.parallel_testing, cfg.termination_condition,
            cfg.time_evaluation, cfg.accuracy_evaluation,
            tc_threshold=cfg.problem.tc_threshold,
